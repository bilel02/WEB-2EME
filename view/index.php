...
if (isset($_GET['action']) && $_GET['action'] === 'create') {
  ...
  $reclamation->addReclamation($_POST['name'], $_POST['familyName'], $_POST['email'], $_POST['category'], $_POST['reclamationText']);
        ...
        <div class="reclamation-box mx-auto" style="width: 600px; height: 600px; border: 2px solid black; background-color: white;"> 
          ...
          <form method="POST" action="index.php?action=create">
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control" id="nameInputt"  name="familyName" required>
              <p style="color: red" id="nomEr"></p>
            </div>
            <div class="form-group mb-3">
              <label for="emailInput" class="form-label">Email</label>
              <input type="email" class="form-control" id="emailInput" name="email" style="color: red" id="adEr" required>
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
              <label for="reclamationText" class="form-label">Text de eclamation</label>
              <textarea class="form-control" id="reclamationText" rows="3" name="reclamationText"></textarea>
              <p style="color: red" id="descEr"></p>
            </div>
            <script src=saisir.js ></script>
            <button type="submit" class="btn btn-primary"  onclick="return validateForm()">Envoyer</button>
            <script>
function validateForm() {
  var name = document.getElementById("nameInput").value;
   var fname = document.getElementById("nameInputt").value;
